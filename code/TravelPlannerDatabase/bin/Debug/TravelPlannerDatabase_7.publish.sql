...
GO
PRINT N'Creating Table [dbo].[Transportation]...';
...
ALTER TABLE [dbo].[Transportation] WITH NOCHECK
    ADD CONSTRAINT [FK_dbo.Transportation_dbo.DepartingWaypoint_Id] FOREIGN KEY ([DepartingWaypointId]) REFERENCES [dbo].[Waypoints] ([Id]) ON DELETE CASCADE;
...
GO
ALTER TABLE [dbo].[Transportation] WITH NOCHECK
    ADD CONSTRAINT [FK_dbo.Transportation_dbo.Trip_Id] FOREIGN KEY ([TripId]) REFERENCES [dbo].[Trip] ([Id]) ON DELETE CASCADE;
