...
{
    /// <summary>
    ///     Testes get overlapping waypoints
    /// </summary>
    [TestClass]
    public class GetOverlappingWaypointsTests
    {
        ...
        /// <summary>
        ///     Tests the get overlapping waypoints.
        /// </summary>
        [TestMethod]
        public void TestGetOverlappingWaypoints()
        {
            ...
            var tripData = new List<Trip> {
                new Trip {
                    Name = "Trip1", StartDate = DateTime.Now, EndDate = DateTime.Now.AddHours(4), UserId = 0, Id = 0
                }
            }.AsQueryable();
            ...
            Assert.AreEqual(2,
                waypointService.GetOverlappingWaypoints(DateTime.Now, DateTime.Now.AddDays(1).AddHours(-1)).Count());
