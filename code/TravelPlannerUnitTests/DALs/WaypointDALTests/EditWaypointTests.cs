...
{
    [TestClass]
    public class EditWaypointTests
    {
        /// <summary>
        ...
        public void TestNullLocation()
        {
            ...
            Assert.ThrowsException<ArgumentNullException>(() =>
                waypointService.EditWaypoint(null, DateTime.Now, DateTime.Now.AddHours(2),  "No"));
        }
        ...
        public void TestEmptyLocation()
        {
            ...
            Assert.ThrowsException<ArgumentNullException>(() =>
                waypointService.EditWaypoint("", DateTime.Now, DateTime.Now.AddHours(2), "No"));
        }
        ...
        public void TestStartDateAfterEndDate()
        {
            ...
            Assert.ThrowsException<ArgumentException>(() =>
                waypointService.EditWaypoint("there", DateTime.Now.AddHours(1), DateTime.Now, "No"));
        ...
        public void TestStartTimeBeforeTripStartTime()
        {
            ...
            Assert.ThrowsException<ArgumentException>(() =>
                waypointService.EditWaypoint("there", DateTime.Now.AddHours(-1), DateTime.Now.AddHours(2), "No"));
            LoggedUser.SelectedTrip = null;
        }
        ...
        public void TestEndTimeAfterTripEndTime()
        {
            ...
            Assert.ThrowsException<ArgumentException>(() =>
                waypointService.EditWaypoint("there", DateTime.Now.AddDays(12), DateTime.Now.AddDays(16), "No"));
            LoggedUser.SelectedTrip = null;
        }
        ...
        /// </summary>
        [TestMethod]
        public void TestEditValidWaypoint()
        {
            LoggedUser.SelectedTrip = new Trip
            { Name = "Trip1", StartDate = DateTime.Now, EndDate = DateTime.Now.AddDays(14), UserId = 0, Id = 0 };
            ...
            var waypointService = new WaypointDal(mockContext.Object);
            LoggedUser.SelectedWaypoint = waypointService.EditWaypoint("there", DateTime.Now.AddDays(5), DateTime.Now.AddDays(10), "No");

            Assert.AreEqual("there", LoggedUser.SelectedWaypoint.Location);
            LoggedUser.SelectedTrip = null;
